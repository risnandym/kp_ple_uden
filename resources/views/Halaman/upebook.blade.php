        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('upebook')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tambah File E-book</h1>
            <p class="card-text">
                  Halaman Ini Khusus untuk mengampluad file E-book yang baru.
                </p>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('index')}}">Home</a></li>
              <li class="breadcrumb-item active">Upload E-book</li>
    ...
    {{csrf_field()}}
    <input class=" mr-4 col-lg-3" type="text" name="tittle" placeholder="tittle">
    <input class="ml-2 col-lg-3" type="text" name="description" placeholder="description">
