        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('view2')}}" class="nav-link   active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Journal</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Daftar Journal</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Daftar Journal</h5>
                </br>
    ...
    @foreach($file as $key=>$data)
      <tr>
        ...
        <td>{{$data->judul}}</td>
        <td>{{$data->penulis}}</td>
        <td> <a href="/files2/{{$data->id}}">View</a></td>
        <td> <a href="/file2/download/{{$data->file}}">Download</a></td>
      </tr>
    @endforeach
    </table>
